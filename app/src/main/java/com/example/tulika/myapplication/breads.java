...
public class breads extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.inc2:
                ...
                cart c2=new cart("Chapati",k2,15);
                if(user != null)
                {
                    if(k2==1)
                    {
            ...
            case R.id.inc3:
                ...
                cart c3=new cart("Butter Nan",k3,25);
                if(user != null)
                {
                    if(k3==1)
                    {
            ...
            case R.id.inc4:
                ...
                cart c4=new cart("Garlic Nan",k4,40);
                if(user != null)
                {
                    if(k4==1)
                    {
            ...
            case R.id.dec2:
                ...
                l2--;
                cart c6=new cart("Chapati",l2,15);
                if(l2<=0)
                {
                    q2.setText("0");
            ...
            case R.id.dec3:
                ...
                l3--;
                cart c7=new cart("Butter Nan",l3,25);
                if(l3<=0)
                {
                    q3.setText("0");
            ...
            case R.id.dec4:
                ...
                l4--;
                cart c8=new cart("Garlic Nan",l4,40);
                if(l4<=0)
                {
                    q4.setText("0");
