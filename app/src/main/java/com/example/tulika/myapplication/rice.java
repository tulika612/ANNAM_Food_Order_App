...
public class rice extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.rice, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.inc1:
                ...
                cart c=new cart("Plain Rice",k1,35);
                if(user != null)
                {
                    if(k1==1)
                    {
            ...
            case R.id.inc2:
                ...
                cart c2=new cart("Jeera Rice",k2,50);
                if(user != null)
                {
                    if(k2==1)
                    {
            ...
            case R.id.inc3:
                ...
                cart c3=new cart("Khichdi",k3,60);
                if(user != null)
                {
                    if(k3==1)
                    {
            ...
            case R.id.inc4:
                ...
                cart c4=new cart("Curd Rice",k4,55);
                if(user != null)
                {
                    if(k4==1)
                    {
            ...
            case R.id.dec1:
                ...
                l1--;
                cart c5=new cart("Plain Rice",l1,35);
                if(l1<=0)
                {
                    q1.setText("0");
            ...
            case R.id.dec2:
                ...
                l2--;
                cart c6=new cart("Jeera Rice",l2,50);
                if(l2<=0)
                {
                    q2.setText("0");
            ...
            case R.id.dec3:
                ...
                l3--;
                cart c7=new cart("Khichdi",l3,60);
                if(l3<=0)
                {
                    q3.setText("0");
            ...
            case R.id.dec4:
                ...
                l4--;
                cart c8=new cart("Curd Rice",l4,55);
                if(l4<=0)
                {
                    q4.setText("0");
