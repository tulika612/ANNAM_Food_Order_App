    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.inc1:
                ...
                cart c=new cart("Panner Masala",k1,80);
                if(user != null)
                {
                    if(k1==1)
                    {
            ...
            case R.id.inc2:
                ...
                cart c2=new cart("Malai Kofta",k2,90);
                if(user != null)
                {
                    if(k2==1)
                    {
            ...
            case R.id.inc3:
                ...
                cart c3=new cart("ShevBhaji",k3,70);
                if(user != null)
                {
                    if(k3==1)
                    {
            ...
            case R.id.inc4:
                ...
                cart c4=new cart("Bhendi Masala",k4,75);
                if(user != null)
                {
                    if(k4==1)
                    {
            ...
            case R.id.dec1:
                ...
                l1--;
                cart c5=new cart("Panner Masala",l1,80);
                if(l1<=0)
                {
                    q1.setText("0");
            ...
            case R.id.dec2:
                ...
                l2--;
                cart c6=new cart("Malai Kofta",l2,90);
                if(l2<=0)
                {
                    q2.setText("0");
            ...
            case R.id.dec3:
                ...
                l3--;
                cart c7=new cart("ShevBhaji",l3,70);
                if(l3<=0)
                {
                    q3.setText("0");
            ...
            case R.id.dec4:
                ...
                l4--;
                cart c8=new cart("Bhendi Masala",l4,75);
                if(l4<=0)
                {
                    q4.setText("0");
