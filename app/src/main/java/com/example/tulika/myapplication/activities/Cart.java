...
import com.example.tulika.myapplication.MyAdapter;
import com.example.tulika.myapplication.R;
import com.example.tulika.myapplication.User_Info;
import com.example.tulika.myapplication.cart;
...
public class Cart extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    c=ds.getValue(cart.class);
                    Log.d(TAG, "Iam in cart");
    ...
    public void onClick(View v) {
        if(v==proceed)
        {
            if(sum==0)
            {
                Toast.makeText(Cart.this,"Cannot Proceed", Toast.LENGTH_LONG);
            }
            else
            {
